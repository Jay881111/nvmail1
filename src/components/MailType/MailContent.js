...
function MailContent() {
    ...
    const { senderID, title } = location.state;
            ...
            <div className="px-7">
                <div className="flex py-[11px] h-[46px] pb-[11px] items-center border-t-[1px] border-b-[1px]">
                    <div className="flex items-center justify-between w-[215px] pl-5 pr-5">
                        <Link to={{ pathname: `/write` }} state={{ senderID }} className="flex -ml-[15px] w-[51px]  h-[28px] hover:border-[1px] rounded-[5px] border-gray-200">
                            <div className="flex items-center mx-auto my-auto">
                                <div className="font-semibold">답장</div>
                            </div>
                        </Link>
                        <Link state={{ senderID }} className="flex w-[80px]  h-[28px] hover:border-[1px] rounded-[5px] border-gray-200">
                            <div className="flex items-center mx-auto my-auto">
                                <div className="font-semibold">전체답장</div>
                            </div>
                        </Link>{' '}
                        <Link to={{ pathname: `/write` }} state={{ senderID }} className="flex w-[51px]  h-[28px] hover:border-[1px] rounded-[5px] border-gray-200">
                            <div className="flex items-center mx-auto my-auto">
                ...
                <div className="flex p-[8px] items-center">
                    <button onClick={handleFold}>{showSender ? <KeyboardArrowUpIcon /> : <KeyboardArrowDownIcon />}</button>

                    <div className="p-1">보낸사람</div>
                    <button className="hover:bg-blue-100 hover:underline ml-1 px-2 py-1 rounded-[15px] bg-blue-50">{senderID}&#60;id@email.com&#62;</button>
                    <button className="hover:font-semibold text-[13px] p-1 ml-1 border-[1px] text-center rounded-[15px] w-[42px]">VIP</button>
                </div>
                {showSender ? (
                    <div>
                        <div className="flex ml-6 px-[8px] items-center">
                            ...
                            <button className="hover:bg-blue-100 hover:underline ml-1 px-2 py-1 rounded-[15px] bg-blue-50">ID&#60;id@email.com&#62;</button>
                        </div>
                        <div className="p-3 pl-9 text-gray-500 text-[12.5px]">2023년 3월 2일 (목) 오후 8:46</div>
                    </div>
                ) : (
                    ''
                )}
