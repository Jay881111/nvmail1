    ...
    <div className="header">
      ...
      <div className="flex pl-2">
        <div className="flex my-auto items-center">
          ...
          <button
            onClick={handleOpen}
            className="ml-2 text-[10.5px] text-black font-[200]"
          >
            ID here
          </button>
        ...
        >
          <Box sx={{ ...style, width: 310 }}>
              ...
              <div className="flex items-center w-full pl-[19px]">
                ...
                <div className="ml-5">
                  <div className="flex w-full">
                    ...
                    <div className="font-[300] text-[12px] ml-2 my-auto border-[1px] text-center w-[50px]">
                      로그아웃
                    </div>
                  </div>
                  <div className="text-[12.5px] -mt-[4px] font-[500] text-gray-600">
                    email@email.com
                  </div>
            ...
            <div className="flex items-center mt-4 w-full justify-around border-t-[1px] font-[500] bg-gray-50 text-[12.5px]">
              ...
              <button className="border-l-[1px] w-[33%] py-2">
                가입한 카페
              </button>
              <button className="border-l-[1px] w-[33%] py-2">
                네이버plus
