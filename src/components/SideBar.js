...
function SideBar() {
    ...
    return (
        <div className="absolute top-[55px] text-[14px] border-r-[0.5px] bg-[#F6F7FA] w-[250px]">
            <div className="w-[250px] relative">
                <div className="flex items-center px-4 text-white pt-4">
                    <Link className="w-[110px] bg-[#02c75a] rounded-l-[5px] text-center p-[7px]" to="/write">
                        메일 쓰기
                    </Link>

                    <Link className="w-[110px] bg-[#02c75a] border-l-[0.5px] rounded-r-[5px] p-[7px] text-center">내게 쓰기</Link>
                </div>
                {/* mail filter Icons */}
                <div className="flex items-center px-3 p-[10px] justify-around">
                    ...
                    <button className="text-center hover:text-[#0173E5] hover:border-[#0173E5]">
                        <div className="text-[5px] font-semibold border-[1.5px] hover:text-[#0173E5] hover:border-[#0173E5] rounded-[30px] w-[25px] border-black mt-[3px] ">To</div>
            ...
            <div className="sidebar">
                <div className="px-[18px] pt-[12px] pb-[8px]">
                    <div className="flex items-center p-[5px] px-[6px] justify-between hover:bg-gray-200 hover:rounded-[5px]">
                        ...
                        <button className="bg-[#FBFBFD] border-[0.5px] text-[11px] text-gray-500 rounded-[5px] text-center px-[7px] my-auto p-[2px] hover:border-[1px] hover:border-gray-300">정리하기</button>
                    </div>
                    ...
                    <div className="flex items-center p-[5px] px-[6px] mt-[5px] justify-between hover:bg-gray-200 hover:rounded-[5px]">
                        ...
                        <button className="bg-[#FBFBFD] border-[0.5px] text-[11px] text-gray-500 rounded-[5px] text-center px-[7px] my-auto p-[2px] hover:border-[1px] hover:border-gray-300">수신확인</button>
                    </div>
                    <div className="flex items-center p-[5px] px-[6px] mt-[5px] justify-between hover:bg-gray-200 hover:rounded-[5px]">
                        <button className="flex items-center">
                ...
                <div className="px-[19.5px] p-[2.5px]">
                    <div className="flex items-center p-[5px] px-[6px] mt-[3.5px] justify-between hover:bg-gray-200 hover:rounded-[5px]">
                        ...
                        <div className="bg-[#FBFBFD] border-[0.5px] text-[11px] text-gray-500 rounded-[5px] text-center px-[12px] my-auto p-[2px]">비우기</div>
                    </div>
                    <div className="flex items-center p-[5px] px-[6px] mt-[3.5px] justify-between hover:bg-gray-200 hover:rounded-[5px]">
                ...
                <div className="px-5 p-2 text-[13px]">
                    <div className="flex items-center p-[5px] px-[6px] mt-[3.5px] justify-between hover:bg-gray-200 hover:rounded-[5px]">환경설정</div>
                    <div className="flex items-center p-[5px] px-[6px] mt-[3.5px] justify-between hover:bg-gray-200 hover:rounded-[5px]">고객센터</div>
                    <div className="flex items-center p-[5px] px-[6px] mt-[3.5px] justify-between hover:bg-gray-200 hover:rounded-[5px]">
                        <div>메일용량</div>
                        <div>
                    ...
                    <div className="flex items-center p-[5px] px-[6px] mt-[3.5px] justify-between hover:bg-gray-200 hover:rounded-[5px]">공지사항</div>
                    <div className="flex items-center p-[5px] px-[6px] mt-[3.5px] justify-between hover:bg-gray-200 hover:rounded-[5px]">공지사항</div>
                    <div className="flex items-center p-[5px] px-[6px] mt-[3.5px] justify-between hover:bg-gray-200 hover:rounded-[5px]">공지사항</div>
                    <div className="flex items-center p-[5px] px-[6px] mt-[3.5px] justify-between hover:bg-gray-200 hover:rounded-[5px]">공지사항</div>
                    <div className="flex items-center p-[5px] px-[6px] mt-[3.5px] justify-between hover:bg-gray-200 hover:rounded-[5px]">공지사항</div>
                    <div className="text-gray-600 font-[400] text-[12px] px-2 mt-1">[안내] 네이버메일 코드 학습용입니다</div>
                </div>
            </div>
        </div>
    );
