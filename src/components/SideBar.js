      ...
      <div className="sidebar">
        <div className="px-[18px] pt-[12px] pb-[8px]">
          ...
          <Section
            ...
            sideBox="수신확인"
          />
          <Section Icon={InsertDriveFileIcon} boxType="임시보관함" link="/" />
          <Section Icon={ArticleIcon} boxType="내게쓴메일함" link="/" />
        </div>
        <div className="w-full border-b-[0.5px]" />
        {/* 메일분류2 */}
        <div className="px-[18px] pt-[5px] pb-[8px]">
          ...
          {open ? (
            <>
              <div className="flex ml-[2px] text-[14px] w-[210px]">
                <Section boxType="프로모션" />
              </div>
              <div className="flex ml-[2px] text-[14px] w-[210px]">
                <Section boxType="청구&#183;결제" />
              </div>
              <div className="flex ml-[2px] text-[14px] w-[210px]">
                <Section boxType="SNS" />
              </div>
        ...
        <div className="flex p-3 items-center px-6 justify-between">
          <div className="text-[12.5px] font-[400] text-gray-500">
            내 메일함
          </div>
          <KeyboardArrowDownIcon fontSize="small" />
        </div>
